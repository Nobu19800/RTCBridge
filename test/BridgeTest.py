...
bridgetest_spec = ["implementation_id", "BridgeTest", 
		 "type_name",         "BridgeTest", 
...
# 
# 
class BridgeTest(OpenRTM_aist.DataFlowComponentBase):
	...
	def __init__(self, manager):
		...
		self._d_in = OpenRTM_aist.instantiateDataType(Img.CameraDeviceProfile)
		"""
		"""
...
def BridgeTestInit(manager):
    profile = OpenRTM_aist.Properties(defaults_str=bridgetest_spec)
    manager.registerFactory(profile,
                            BridgeTest,
                            OpenRTM_aist.Delete)

def MyModuleInit(manager):
    BridgeTestInit(manager)

    # Create a component
    comp = manager.createComponent("BridgeTest")
